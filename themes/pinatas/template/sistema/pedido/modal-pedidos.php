<div id="modal-pedidos_<?php echo $post_id; ?>" class="modal modal-pedidos">
	<div class="exit-modal"></div>
	<div class="modal-content">
		<i class="icon-close close-modal"></i>
		<p class="color-primary text-center margin-bottom-20 fz-20">Pedidos <?php echo $productName; ?></p>
